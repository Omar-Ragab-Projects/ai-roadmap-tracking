export default function FocusTimer({
  ...
  return (
    ...
    >
      ...
      <span className="text-7xl lg:text-9xl font-bold text-foreground  tracking-[-0.075em] ">
        {timer.minutes}
      </span>
      <span className="text-5xl lg:text-7xl font-bold text-muted-foreground -mt-3  tracking-tighter">
