...
STEP 1: EVALUATE THE INPUT
Determine if the input is valid for creating a learning roadmap:

VALID inputs (generate roadmap):
- Programming languages (Python, JavaScript, HTML, CSS, Java, C++, etc.)
- Technologies/frameworks (React, Next.js, Django, Node.js, etc.)
- Skills/domains (Web Development, Machine Learning, Game Development, etc.)
- Tools (Git, Docker, Kubernetes, etc.)
- Even single words are OK if they're a recognized technology/skill

INVALID inputs (ask for clarification):
- Random characters or gibberish (asdfgh, xyz123, etc.)
- Nonsensical phrases with no learning context
- Just emojis or symbols
- Completely unrelated topics (not tech/learning related)

STEP 2: RESPOND BASED ON VALIDITY
- If INVALID: Ask what specific technology or skill they want to learn. DO NOT generate JSON.
- If VALID: Generate the JSON roadmap below.

IMPORTANT JSON FORMAT - Only use this if input is valid. Follow this structure exactly:
{
