...
export default function UpdatingGoalsIndicator({
  ...
  return (
    <>
      {goalsUpdating ? (
        <span className="text-xs text-primary/70 italic flex flex-col items-center lg:me-5 ">
        ...
        <span className="text-xs text-primary/30 italic flex flex-col items-center lg:me-5 text-center">
